          ...
          <motion.div className="order-1 lg:order-2" style={{ y: textY }}>
            ...
            >
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-400 leading-relaxed">
                I specialize in turning UI designs into clean, performant code
                and have worked on several live e-commerce and CMS platforms
                with integrated payment systems like Stripe, eSewa, and Khalti.
                My focus is always on delivering smooth user experiences,
                optimized performance, and scalable frontends.
              </p>

              <p className="text-sm sm:text-base lg:text-lg text-gray-400 leading-relaxed">
                Whether it's crafting pixel-perfect components, integrating
                APIs, or collaborating with teams to bring ideas to life, I
                enjoy the process of solving real-world problems through code.
              </p>
            </motion.div>
