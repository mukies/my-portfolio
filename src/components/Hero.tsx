...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="relative w-full min-h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-5 dark:opacity-10">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse" className="sm:w-[60px] sm:h-[60px]">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" strokeWidth="1" className="sm:d-['M 60 0 L 0 0 0 60']"/>
              </pattern>
            </defs>
      ...
      <div className="container mx-auto relative z-10 w-full">
        ...
        >
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Available for freelance work</span>
          </motion.div>
